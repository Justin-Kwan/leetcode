...
class Solution:
    ...
    def searchBoardWords(self, board: List[List[str]], cell: tuple[int, int], parent: TrieNode, curWord: List[str], foundWords: List[str]) -> None:
        ...
        if curNode.isEndOfWord:
            foundWords.append("".join(curWord))
        ...
        # (delete if no other words are shared by path or remove end of word
        # flag to skip adding word in future if longer word paths exist under)
